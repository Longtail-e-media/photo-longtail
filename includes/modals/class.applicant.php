...
class Applicant extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'fullname', 'current_address', 'mobile', 'phone', 'email', 'position', 'myfile', 'qualification', 'photo', 'citizenship', 'cover_letter', 'sortorder'
    );
    ...
    public $photo, $citizenship, $cover_letter;
    public $sortorder;
