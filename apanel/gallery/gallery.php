            ...
            <form action="" class="col-md-12 center-margin" method="post" id="gallery_frm">
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        ...
                        <textarea name="content" id="content"
                                  class="large-textarea validate[required]"><?php echo !empty($galleryInfo->content) ? $galleryInfo->content : ""; ?></textarea>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-2">
                        <select id="destinationId" name="destinationId" class="validate[required]">
                            <option value="">Select Destination</option>
                            <?php
                                $selval=isset($_GET['id']) ? $galleryInfo->destinationId : '';
                                echo Destination::get_destination_option($selval);
                            ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row " style="display:none">
                    ...
                    <div class="form-input col-md-2">
                        <select id="type" name="type" >
                            <option value="1" <?php echo (!empty($galleryInfo->type) and $galleryInfo->type == '1') ? 'selected' : ""; ?> selected>
                                Inner Page
                            </option>
...
include("gallery_images_homepage.php"); ?>