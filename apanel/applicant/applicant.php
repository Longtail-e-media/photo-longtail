...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEditApplicant"):
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
        ...
        <tr>
            ...
            <td><a href="<?= BASE_URL ?>images/career/<?php echo $appInfo->photo; ?>" target="_blank"><?php echo $appInfo->photo; ?></a></td>
        </tr>
        <tr>
            <th class="text-center">Citizenship</th>
            <td><a href="<?= BASE_URL ?>images/career/<?php echo $appInfo->citizenship; ?>" target="_blank"><?php echo $appInfo->citizenship; ?></a></td>
        </tr>
        <tr>
            <th class="text-center">Cover letter / Application</th>
            <td><a href="<?= BASE_URL ?>images/career/<?php echo $appInfo->cover_letter; ?>" target="_blank"><?php echo $appInfo->cover_letter; ?></a></td>
        </tr>
        </tbody>
    </table>
<?php endif; ?>